...
public class BlockDiagonalSecondOrderLatentFactorModel_ThreadEqual {
    ...
    public BlockDiagonalSecondOrderLatentFactorModel_ThreadEqual() throws IOException {
        /** 初始化数据集合 */
    ...
    public BlockDiagonalSecondOrderLatentFactorModel_ThreadEqual(double gamma, double tolerance, double lambda, int threadNum, List<String> modelOutputString) throws IOException {
        this();
        this.gamma = gamma;
