 ...
 * @Version 1.0
 */
public class SecondOrderLatentFactorModel_MAE {
    ...
    public SecondOrderLatentFactorModel_MAE() throws IOException {
        /** 初始化数据集合 */
    ...
    public SecondOrderLatentFactorModel_MAE(double gamma, double tolerance, double lambda, List<String> modelOutputString) throws IOException {
        this();
        this.gamma = gamma;
    ...
    public SecondOrderLatentFactorModel_MAE(double gamma, double tolerance, double lambda, double learningRate, List<String> modelOutputString, double[][] userOriginMatrix, double[][] itemOriginMatrix)
            throws IOException {
        this();
        this.gamma = gamma;
        this.tolerance = tolerance;
    ...
    public void convergenceAnalysis(int epoch) {
        ...
        double testMAE = EvaluationUtil.meanAbsoluteError(this.testEntryList);
        double validationMAE = EvaluationUtil.meanAbsoluteError(this.validationEntryList);
