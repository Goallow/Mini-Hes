...
public class SOLF_ML_20M_v1_Tolerance_100_Damping_1_100_MAE {
    public static void main(String[] args) throws IOException, BrokenBarrierException, InterruptedException {
        ...
        double[] dampingArray = {1.0, 10, 20, 40, 60, 80, 100};
        ...
        FileUtil.saveOutputResult(modelOutString, "SLF_20M" + "_tolerance_100_damping_1_to_100_regularization", "MAE_Density_Large", Constant.SAVE_FILE_PATH);
    }
}
