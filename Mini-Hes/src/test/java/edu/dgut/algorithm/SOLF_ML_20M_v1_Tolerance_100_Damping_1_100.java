...
public class SOLF_ML_20M_v1_Tolerance_100_Damping_1_100 {
    public static void main(String[] args) throws IOException, BrokenBarrierException, InterruptedException {
        ...
        FileUtil.saveOutputResult(modelOutString, "SLF_20M" + "_tolerance_100_damping_1_to_100_regularization", "RMSE_Density_Large", Constant.SAVE_FILE_PATH);
    }
}
