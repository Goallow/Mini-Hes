...
public class SOLF_ML_20M_v1_Tolerance_100_Damping_200_300_MAE {
    public static void main(String[] args) throws IOException, BrokenBarrierException, InterruptedException {
        ...
        FileUtil.saveOutputResult(modelOutString, "SLF_20M" + "_tolerance_100_damping_200_to_300_regularization", "MAE_Density_Large", Constant.SAVE_FILE_PATH);
    }
}
