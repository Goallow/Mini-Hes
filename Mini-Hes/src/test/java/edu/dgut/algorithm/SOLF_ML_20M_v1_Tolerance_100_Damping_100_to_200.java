...
public class SOLF_ML_20M_v1_Tolerance_100_Damping_100_to_200 {
    public static void main(String[] args) throws IOException, BrokenBarrierException, InterruptedException {
        ...
        FileUtil.saveOutputResult(modelOutString, "SLF_20M" + "_tolerance_100_damping_100_to_200_regularization", "RMSE_Density_Large", Constant.SAVE_FILE_PATH);
    }
}
